...
// Source: capability.json (spec release/2026-08-25@cd78fb3)
...
func (v *CapabilityBase) Validate() error {
	...
	if !pattern_CapabilityBase_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}

// CapabilityBusinessSchema Capability declaration for business/merchant discovery. Requires the `schema` URL so platforms can fetch and compose it during negotiation; may also include business-specific config overrides.
...
func (v *CapabilityBusinessSchema) Validate() error {
	...
	if !pattern_CapabilityBusinessSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
...
func (v *CapabilityPlatformSchema) Validate() error {
	...
	if !pattern_CapabilityPlatformSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
...
func (v *CapabilityResponseSchema) Validate() error {
	...
	if !pattern_CapabilityResponseSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
