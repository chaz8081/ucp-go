...
// Source: common/identity_linking.json (spec release/2026-08-25@cd78fb3)
...
// in Extra.
func (v *IdentityLinkingProvider) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("IdentityLinkingProvider: null is not a valid object")
	}
	type IdentityLinkingProviderAlias IdentityLinkingProvider
	var named IdentityLinkingProviderAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = IdentityLinkingProvider(named)
...
// Extra.
func (v IdentityLinkingProvider) MarshalJSON() ([]byte, error) {
	type IdentityLinkingProviderAlias IdentityLinkingProvider
	named, err := json.Marshal(IdentityLinkingProviderAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *IdentityLinkingProvider) Validate() error {
	if v.present != nil {
		if !v.present["type"] {
...
var pattern_IdentityLinkingScopeToken = sync.OnceValue(func() *regexp.Regexp {
	return regexp.MustCompile("^[a-z](?:[a-z0-9-]*[a-z0-9])?(?:\\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9_])?)+:[a-z][a-z0-9_]*$")
})

// Validate reports the first constraint violation, or nil.
func (v *IdentityLinkingScopeToken) Validate() error {
	if !pattern_IdentityLinkingScopeToken().MatchString(string(string(*v))) {
