...
// Source: common/payment_authentication.json (spec release/2026-08-25@cd78fb3)
...
// PaymentAuthenticationCheckout is generated from common/payment_authentication.json.
type PaymentAuthenticationCheckout struct {
...
// in Extra.
func (v *PaymentAuthenticationCheckout) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PaymentAuthenticationCheckout: null is not a valid object")
	}
	type PaymentAuthenticationCheckoutAlias PaymentAuthenticationCheckout
	var named PaymentAuthenticationCheckoutAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PaymentAuthenticationCheckout(named)
...
// Extra.
func (v PaymentAuthenticationCheckout) MarshalJSON() ([]byte, error) {
	type PaymentAuthenticationCheckoutAlias PaymentAuthenticationCheckout
	named, err := json.Marshal(PaymentAuthenticationCheckoutAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PaymentAuthenticationCheckout) Validate() error {
	if v.present != nil {
