...
// Source: common/types/context.json (spec release/2026-08-25@cd78fb3)
...
type Context struct {
	...
	Eligibility []ReverseDomainName `json:"eligibility,omitzero"`
	...
	Payment []ContextPaymentItem `json:"payment,omitzero"`
...
func (v Context) MarshalJSON() ([]byte, error) {
	type ContextAlias Context
	named, err := json.Marshal(ContextAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
// ContextPaymentItem is generated from common/types/context.json.
type ContextPaymentItem struct {
...
// UnmarshalJSON decodes the named properties and keeps everything else
// in Extra.
func (v *ContextPaymentItem) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("ContextPaymentItem: null is not a valid object")
	}
	type ContextPaymentItemAlias ContextPaymentItem
	var named ContextPaymentItemAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = ContextPaymentItem(named)
...
// MarshalJSON emits the named properties alongside anything held in
// Extra.
func (v ContextPaymentItem) MarshalJSON() ([]byte, error) {
	type ContextPaymentItemAlias ContextPaymentItem
	named, err := json.Marshal(ContextPaymentItemAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
// Validate reports the first constraint violation, or nil.
func (v *ContextPaymentItem) Validate() error {
	if v.present != nil {
