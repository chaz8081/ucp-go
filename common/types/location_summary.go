...
// Source: common/types/location_summary.json (spec release/2026-08-25@cd78fb3)
...
// LocationSummary A summary of a physical business location.
...
// in Extra.
func (v *LocationSummary) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("LocationSummary: null is not a valid object")
	}
	type LocationSummaryAlias LocationSummary
	var named LocationSummaryAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = LocationSummary(named)
...
// Extra.
func (v LocationSummary) MarshalJSON() ([]byte, error) {
	type LocationSummaryAlias LocationSummary
	named, err := json.Marshal(LocationSummaryAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *LocationSummary) Validate() error {
	if v.present != nil {
		if !v.present["id"] {
