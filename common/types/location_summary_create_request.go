...
// Source: common/types/location_summary_create_request.json (spec release/2026-08-25@cd78fb3)
...
// LocationSummaryCreateRequest A summary of a physical business location.
type LocationSummaryCreateRequest struct {
...
// in Extra.
func (v *LocationSummaryCreateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("LocationSummaryCreateRequest: null is not a valid object")
	}
	type LocationSummaryCreateRequestAlias LocationSummaryCreateRequest
	var named LocationSummaryCreateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = LocationSummaryCreateRequest(named)
...
// Extra.
func (v LocationSummaryCreateRequest) MarshalJSON() ([]byte, error) {
	type LocationSummaryCreateRequestAlias LocationSummaryCreateRequest
	named, err := json.Marshal(LocationSummaryCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *LocationSummaryCreateRequest) Validate() error {
	if v.present != nil {
		if !v.present["id"] {
