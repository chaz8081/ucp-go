...
// Source: common/types/message_warning_create_request.json (spec release/2026-08-25@cd78fb3)
...
// MessageWarningCreateRequest is generated from common/types/message_warning_create_request.json.
