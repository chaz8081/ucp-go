...
// Source: common/types/payment_identity.json (spec release/2026-08-25@cd78fb3)
...
// PaymentIdentity Identity of a participant for token binding. The access_token uniquely identifies the participant whom tokens should be issued to.
