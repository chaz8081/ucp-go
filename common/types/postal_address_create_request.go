...
// Source: common/types/postal_address_create_request.json (spec release/2026-08-25@cd78fb3)
...
// PostalAddressCreateRequest is generated from common/types/postal_address_create_request.json.
