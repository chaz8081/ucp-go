...
// Source: common/types/postal_address_update_request.json (spec release/2026-08-25@cd78fb3)
...
// PostalAddressUpdateRequest is generated from common/types/postal_address_update_request.json.
...
func (v *PostalAddressUpdateRequest) UnmarshalJSON(data []byte) error {
	...
	*v = PostalAddressUpdateRequest(named)
...
// Extra.
func (v PostalAddressUpdateRequest) MarshalJSON() ([]byte, error) {
	type PostalAddressUpdateRequestAlias PostalAddressUpdateRequest
	named, err := json.Marshal(PostalAddressUpdateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PostalAddressUpdateRequest) Validate() error {
	return nil
}
