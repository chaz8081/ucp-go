...
// Source: common/types/price_range.json (spec release/2026-08-25@cd78fb3)
...
// PriceRange A price range representing minimum and maximum values (e.g., a common example in retail shopping is when prices vary across product variants).
