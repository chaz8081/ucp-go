...
// Source: payment_handler.json (spec release/2026-08-25@cd78fb3)
...
func (v *PaymentHandlerBase) Validate() error {
	...
	if !pattern_PaymentHandlerBase_Version().MatchString(string(v.Version)) {
...
func (v *PaymentHandlerBusinessSchema) Validate() error {
	...
	if !pattern_PaymentHandlerBusinessSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	for i := range v.AvailableInstruments {
		if err := v.AvailableInstruments[i].Validate(); err != nil {
...
func (v *PaymentHandlerPlatformSchema) Validate() error {
	...
	if !pattern_PaymentHandlerPlatformSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	for i := range v.AvailableInstruments {
		if err := v.AvailableInstruments[i].Validate(); err != nil {
...
func (v *PaymentHandlerResponseSchema) Validate() error {
	...
	if !pattern_PaymentHandlerResponseSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	for i := range v.AvailableInstruments {
		if err := v.AvailableInstruments[i].Validate(); err != nil {
