...
// Source: service.json (spec release/2026-08-25@cd78fb3)
...
func (v *ServiceBase) Validate() error {
	...
	if !pattern_ServiceBase_Version().MatchString(string(v.Version)) {
...
func (v *ServiceBusinessSchema) Validate() error {
	...
	if !pattern_ServiceBusinessSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
...
func (v *ServicePlatformSchema) Validate() error {
	...
	if !pattern_ServicePlatformSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
...
func (v *ServiceResponseSchema) Validate() error {
	...
	if !pattern_ServiceResponseSchema_Version().MatchString(string(v.Version)) {
		return errors.New("version: does not match pattern")
	}
	return nil
}
