...
// Source: shopping/cart_create_request.json (spec release/2026-08-25@cd78fb3)
...
// CartCreateRequest Shopping cart with estimated pricing before checkout. Lightweight pre-purchase exploration with no payment info or complex status states.
...
// Extra.
func (v CartCreateRequest) MarshalJSON() ([]byte, error) {
	type CartCreateRequestAlias CartCreateRequest
	named, err := json.Marshal(CartCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *CartCreateRequest) Validate() error {
	if v.present != nil {
...
func (v *CartCreateRequestCheckout) UnmarshalJSON(data []byte) error {
	...
	*v = CartCreateRequestCheckout(named)
...
// MarshalJSON emits the named properties alongside anything held in
// Extra.
func (v CartCreateRequestCheckout) MarshalJSON() ([]byte, error) {
	type CartCreateRequestCheckoutAlias CartCreateRequestCheckout
	named, err := json.Marshal(CartCreateRequestCheckoutAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
