...
// Source: shopping/checkout_create_request.json (spec release/2026-08-25@cd78fb3)
...
type CheckoutCreateRequest struct {
	...
	Context *commontypes.ContextCreateRequest `json:"context,omitzero"`
	// List of line items being checked out.
	LineItems []types.LineItemCreateRequest     `json:"line_items"`
	Payment   *commontypes.PaymentCreateRequest `json:"payment,omitzero"`
	Signals   *commontypes.SignalsCreateRequest `json:"signals,omitzero"`
...
func (v *CheckoutCreateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("CheckoutCreateRequest: null is not a valid object")
	}
