...
// Source: shopping/checkout_update_request.json (spec release/2026-08-25@cd78fb3)
...
// CheckoutUpdateRequest Base checkout schema. Extensions compose onto this using allOf.
...
// Extra.
func (v CheckoutUpdateRequest) MarshalJSON() ([]byte, error) {
	type CheckoutUpdateRequestAlias CheckoutUpdateRequest
	named, err := json.Marshal(CheckoutUpdateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *CheckoutUpdateRequest) Validate() error {
	if v.present != nil {
