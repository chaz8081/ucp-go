...
// Source: shopping/types/adjustment.json (spec release/2026-08-25@cd78fb3)
...
type Adjustment struct {
	...
	Totals []commontypes.Total `json:"totals,omitzero"`
...
type AdjustmentLineItemsItem struct {
	...
	Measure *commontypes.Measure `json:"measure,omitzero"`
