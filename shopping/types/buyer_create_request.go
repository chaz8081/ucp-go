...
// Source: shopping/types/buyer_create_request.json (spec release/2026-08-25@cd78fb3)
...
// Extra.
func (v BuyerCreateRequest) MarshalJSON() ([]byte, error) {
	type BuyerCreateRequestAlias BuyerCreateRequest
	named, err := json.Marshal(BuyerCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *BuyerCreateRequest) Validate() error {
	return nil
}
