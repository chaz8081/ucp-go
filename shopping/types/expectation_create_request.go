...
// Source: shopping/types/expectation_create_request.json (spec release/2026-08-25@cd78fb3)
...
type ExpectationCreateRequest struct {
	...
	Destination commontypes.PostalAddressCreateRequest `json:"destination"`
