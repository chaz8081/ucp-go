...
// Source: shopping/types/fulfillment_create_request.json (spec release/2026-04-08@a2d8bf0)
...
type FulfillmentCreateRequest struct {
	...
	Methods []FulfillmentMethodCreateRequest `json:"methods,omitzero"`
...
func (v *FulfillmentCreateRequest) UnmarshalJSON(data []byte) error {
	...
	*v = FulfillmentCreateRequest(named)
...
// Extra.
func (v FulfillmentCreateRequest) MarshalJSON() ([]byte, error) {
	type FulfillmentCreateRequestAlias FulfillmentCreateRequest
	named, err := json.Marshal(FulfillmentCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *FulfillmentCreateRequest) Validate() error {
