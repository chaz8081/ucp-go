...
// Source: shopping/types/fulfillment_option.json (spec release/2026-08-25@cd78fb3)
...
// FulfillmentOption A fulfillment option within a group (e.g., Standard Shipping $5, Express $15). Extends the fulfillment option base with cost and timing.
