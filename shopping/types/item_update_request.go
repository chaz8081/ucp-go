...
// Source: shopping/types/item_update_request.json (spec release/2026-08-25@cd78fb3)
...
// ItemUpdateRequest is generated from shopping/types/item_update_request.json.
type ItemUpdateRequest struct {
	...
	QuantityUnit *commontypes.QuantityUnitUpdateRequest `json:"quantity_unit,omitzero"`
...
// in Extra.
func (v *ItemUpdateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("ItemUpdateRequest: null is not a valid object")
	}
	type ItemUpdateRequestAlias ItemUpdateRequest
	var named ItemUpdateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = ItemUpdateRequest(named)
...
// Extra.
func (v ItemUpdateRequest) MarshalJSON() ([]byte, error) {
	type ItemUpdateRequestAlias ItemUpdateRequest
	named, err := json.Marshal(ItemUpdateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *ItemUpdateRequest) Validate() error {
	if v.present != nil {
		if !v.present["id"] {
