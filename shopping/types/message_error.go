...
// Source: shopping/types/message_error.json (spec release/2026-04-08@a2d8bf0)
...
// MessageError is generated from shopping/types/message_error.json.
...
func (v *MessageError) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("MessageError: null is not a valid object")
	}
	type MessageErrorAlias MessageError
	var named MessageErrorAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = MessageError(named)
...
func (v MessageError) MarshalJSON() ([]byte, error) {
	type MessageErrorAlias MessageError
	named, err := json.Marshal(MessageErrorAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *MessageError) Validate() error {
	if v.present != nil {
		if !v.present["code"] {
