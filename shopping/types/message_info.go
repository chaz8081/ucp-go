...
// Source: shopping/types/message_info.json (spec release/2026-04-08@a2d8bf0)
...
// MessageInfo is generated from shopping/types/message_info.json.
type MessageInfo struct {
	Code *InfoCode `json:"code,omitzero"`
...
func (v MessageInfo) MarshalJSON() ([]byte, error) {
	type MessageInfoAlias MessageInfo
	named, err := json.Marshal(MessageInfoAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *MessageInfo) Validate() error {
	if v.present != nil {
