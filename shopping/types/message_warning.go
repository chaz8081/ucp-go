...
// Source: shopping/types/message_warning.json (spec release/2026-04-08@a2d8bf0)
...
// MessageWarning is generated from shopping/types/message_warning.json.
...
// Extra.
func (v MessageWarning) MarshalJSON() ([]byte, error) {
	type MessageWarningAlias MessageWarning
	named, err := json.Marshal(MessageWarningAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *MessageWarning) Validate() error {
	if v.present != nil {
		if !v.present["code"] {
