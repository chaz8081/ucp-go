...
// Source: shopping/types/message_warning_create_request.json (spec release/2026-04-08@a2d8bf0)
...
// MessageWarningCreateRequest is generated from shopping/types/message_warning_create_request.json.
type MessageWarningCreateRequest struct {
	Code WarningCodeCreateRequest `json:"code"`
...
// in Extra.
func (v *MessageWarningCreateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("MessageWarningCreateRequest: null is not a valid object")
	}
	type MessageWarningCreateRequestAlias MessageWarningCreateRequest
	var named MessageWarningCreateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = MessageWarningCreateRequest(named)
...
// Extra.
func (v MessageWarningCreateRequest) MarshalJSON() ([]byte, error) {
	type MessageWarningCreateRequestAlias MessageWarningCreateRequest
	named, err := json.Marshal(MessageWarningCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *MessageWarningCreateRequest) Validate() error {
	if v.present != nil {
		if !v.present["code"] {
