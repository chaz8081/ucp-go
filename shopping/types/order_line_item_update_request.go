...
// Source: shopping/types/order_line_item_update_request.json (spec release/2026-04-08@a2d8bf0)
...
type OrderLineItemUpdateRequest struct {
	...
	Totals []TotalUpdateRequest `json:"totals"`
...
// OrderLineItemUpdateRequestQuantity Quantity tracking for the line item.
