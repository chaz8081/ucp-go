...
// Source: shopping/types/payment_credential_update_request.json (spec release/2026-04-08@a2d8bf0)
...
// PaymentCredentialUpdateRequest The base definition for any payment credential. Handlers define specific credential types.
type PaymentCredentialUpdateRequest struct {
...
func (v *PaymentCredentialUpdateRequest) UnmarshalJSON(data []byte) error {
	...
	*v = PaymentCredentialUpdateRequest(named)
...
// Extra.
func (v PaymentCredentialUpdateRequest) MarshalJSON() ([]byte, error) {
	type PaymentCredentialUpdateRequestAlias PaymentCredentialUpdateRequest
	named, err := json.Marshal(PaymentCredentialUpdateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PaymentCredentialUpdateRequest) Validate() error {
	if v.present != nil {
		if !v.present["type"] {
