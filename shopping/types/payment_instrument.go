...
// Source: shopping/types/payment_instrument.json (spec release/2026-04-08@a2d8bf0)
...
// PaymentInstrument The base definition for any payment instrument. It links the instrument to a specific payment handler.
...
// in Extra.
func (v *PaymentInstrument) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PaymentInstrument: null is not a valid object")
	}
	type PaymentInstrumentAlias PaymentInstrument
	var named PaymentInstrumentAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PaymentInstrument(named)
...
// Extra.
func (v PaymentInstrument) MarshalJSON() ([]byte, error) {
	type PaymentInstrumentAlias PaymentInstrument
	named, err := json.Marshal(PaymentInstrumentAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PaymentInstrument) Validate() error {
	if v.present != nil {
...
// PaymentInstrumentSelectedPaymentInstrument A payment instrument with selection state.
type PaymentInstrumentSelectedPaymentInstrument struct {
	// The billing address associated with this payment method.
	BillingAddress *PostalAddress     `json:"billing_address,omitzero"`
	Credential     *PaymentCredential `json:"credential,omitzero"`
	// Display information for this payment instrument. Each payment instrument schema defines its specific display properties, as outlined by the payment handler.
...
// UnmarshalJSON decodes the named properties and keeps everything else
// in Extra.
func (v *PaymentInstrumentSelectedPaymentInstrument) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PaymentInstrumentSelectedPaymentInstrument: null is not a valid object")
	}
	type PaymentInstrumentSelectedPaymentInstrumentAlias PaymentInstrumentSelectedPaymentInstrument
	var named PaymentInstrumentSelectedPaymentInstrumentAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PaymentInstrumentSelectedPaymentInstrument(named)
...
// MarshalJSON emits the named properties alongside anything held in
// Extra.
func (v PaymentInstrumentSelectedPaymentInstrument) MarshalJSON() ([]byte, error) {
	type PaymentInstrumentSelectedPaymentInstrumentAlias PaymentInstrumentSelectedPaymentInstrument
	named, err := json.Marshal(PaymentInstrumentSelectedPaymentInstrumentAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
// Validate reports the first constraint violation, or nil.
func (v *PaymentInstrumentSelectedPaymentInstrument) Validate() error {
	if v.present != nil {
		if !v.present["handler_id"] {
			return errors.New("handler_id: required property is missing")
		}
