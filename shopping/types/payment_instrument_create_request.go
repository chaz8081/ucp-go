...
// Source: shopping/types/payment_instrument_create_request.json (spec release/2026-04-08@a2d8bf0)
...
// PaymentInstrumentCreateRequest The base definition for any payment instrument. It links the instrument to a specific payment handler.
type PaymentInstrumentCreateRequest struct {
...
// in Extra.
func (v *PaymentInstrumentCreateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PaymentInstrumentCreateRequest: null is not a valid object")
	}
	type PaymentInstrumentCreateRequestAlias PaymentInstrumentCreateRequest
	var named PaymentInstrumentCreateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PaymentInstrumentCreateRequest(named)
...
// Extra.
func (v PaymentInstrumentCreateRequest) MarshalJSON() ([]byte, error) {
	type PaymentInstrumentCreateRequestAlias PaymentInstrumentCreateRequest
	named, err := json.Marshal(PaymentInstrumentCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PaymentInstrumentCreateRequest) Validate() error {
	if v.present != nil {
...
// UnmarshalJSON decodes the named properties and keeps everything else
// in Extra.
func (v *PaymentInstrumentCreateRequestSelectedPaymentInstrument) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PaymentInstrumentCreateRequestSelectedPaymentInstrument: null is not a valid object")
	}
	type PaymentInstrumentCreateRequestSelectedPaymentInstrumentAlias PaymentInstrumentCreateRequestSelectedPaymentInstrument
	var named PaymentInstrumentCreateRequestSelectedPaymentInstrumentAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PaymentInstrumentCreateRequestSelectedPaymentInstrument(named)
...
// MarshalJSON emits the named properties alongside anything held in
// Extra.
func (v PaymentInstrumentCreateRequestSelectedPaymentInstrument) MarshalJSON() ([]byte, error) {
	type PaymentInstrumentCreateRequestSelectedPaymentInstrumentAlias PaymentInstrumentCreateRequestSelectedPaymentInstrument
	named, err := json.Marshal(PaymentInstrumentCreateRequestSelectedPaymentInstrumentAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
