...
// Source: shopping/types/postal_address.json (spec release/2026-04-08@a2d8bf0)
...
// PostalAddress is generated from shopping/types/postal_address.json.
...
// in Extra.
func (v *PostalAddress) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PostalAddress: null is not a valid object")
	}
	type PostalAddressAlias PostalAddress
	var named PostalAddressAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PostalAddress(named)
...
func (v PostalAddress) MarshalJSON() ([]byte, error) {
	type PostalAddressAlias PostalAddress
	named, err := json.Marshal(PostalAddressAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PostalAddress) Validate() error {
	return nil
}
