...
// Source: shopping/types/postal_address_create_request.json (spec release/2026-04-08@a2d8bf0)
...
// PostalAddressCreateRequest is generated from shopping/types/postal_address_create_request.json.
type PostalAddressCreateRequest struct {
...
// in Extra.
func (v *PostalAddressCreateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("PostalAddressCreateRequest: null is not a valid object")
	}
	type PostalAddressCreateRequestAlias PostalAddressCreateRequest
	var named PostalAddressCreateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = PostalAddressCreateRequest(named)
...
// Extra.
func (v PostalAddressCreateRequest) MarshalJSON() ([]byte, error) {
	type PostalAddressCreateRequestAlias PostalAddressCreateRequest
	named, err := json.Marshal(PostalAddressCreateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *PostalAddressCreateRequest) Validate() error {
	return nil
}
