...
// Source: shopping/types/shipping_destination_update_request.json (spec release/2026-08-25@cd78fb3)
...
// ShippingDestinationUpdateRequest Shipping destination.
type ShippingDestinationUpdateRequest struct {
...
// in Extra.
func (v *ShippingDestinationUpdateRequest) UnmarshalJSON(data []byte) error {
	if string(data) == "null" {
		return errors.New("ShippingDestinationUpdateRequest: null is not a valid object")
	}
	type ShippingDestinationUpdateRequestAlias ShippingDestinationUpdateRequest
	var named ShippingDestinationUpdateRequestAlias
	if err := json.Unmarshal(data, &named); err != nil {
		return err
	}
	*v = ShippingDestinationUpdateRequest(named)
...
// Extra.
func (v ShippingDestinationUpdateRequest) MarshalJSON() ([]byte, error) {
	type ShippingDestinationUpdateRequestAlias ShippingDestinationUpdateRequest
	named, err := json.Marshal(ShippingDestinationUpdateRequestAlias(v))
	if err != nil {
		return nil, err
	}
	if len(v.Extra) == 0 {
...
func (v *ShippingDestinationUpdateRequest) Validate() error {
	if v.Type != nil && *v.Type != "shipping_address" {
		return errors.New("type: must be \"shipping_address\"")
	}
	return nil
}
